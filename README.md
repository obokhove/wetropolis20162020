...
# CAD programs used 19-02-2019
Solidworks for designs, saves as Step file for import in Rhino (V5), plugin in Rhino for routing: Rhinocam 5, whcih generates routing/freesfiles (NC files), routed on BZT 1400 PF router/frees with Winpc-nc driver.
