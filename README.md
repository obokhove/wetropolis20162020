...
- The topographic landscape with a winding river channel, one-sided flood plain, canals and the city-plain has been routed out of two standard polystyrene foam plates each of dimension 5x60x120xcm3 (plus a small extra foam plate) with an overlay to fit two plates together. A smaller third piece was added to extend the river length after the city which enhanced flooding in the city plain. Drawings have been made in the CAD programs Rhino/Grasshopper and used to steer the router. Routing precision is circa 0.8mm. After the routing, the river channel and its flood plain have been roughened by gluing fine sand to the base, after which it is varnishes with yacht varnish. Specs: https://www.gamma.nl/assortiment/isolatieplaat-polystyreen-xps-120x60x5-cm-4-stuks/p/B133540 Isolatieplaat polystyreen XPS 120x60x5cm3
...
- the more-or-less chronological story of the creation of Wetropolis; it contains the basic information, often *in Dutch*, as well as translation, of various steps and issues we faced in the design. This information may later be ordered differently.
